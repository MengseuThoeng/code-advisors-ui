    ...
    (
        ...
        return (
            ...
            >
                ...
                <div
                    className={cn(
                        "duration-200 mr-2 w-[--sidebar-width] bg-transparent transition-[width] ease-linear",
                ...
                <div
                    className={cn(
                        "duration-200 fixed top-[80px] bottom-0 w-[--sidebar-width] transition-[left,right,width] ease-linear md:flex hidden",
                        side === "left"
